...
def check_viral_clipping(events, FASTA_path, name, viralDb, processes, outDir):
    ...
    eventsIdentity = bamtools_VIGASR.filterBAM2FastaDict_LR(BAM_sorted, minTotalMatchVirus, minParcialMatchVirus, maxMatchCheckMAPQVirus, minMAPQVirus, maxBasePercVirus, minLccVirus, mode='LR')
...
def checkEventsIdentity_deprecated(fastaPath, viralDb, processes, outDir):
    ...
    maxBasePercVirus = 60 # <= 60 (no mucho pero algo filtra)
    minLccVirus = 1.7 # > 1.7
    eventsIdentity = bamtools_VIGASR.filterBAM2FastaDict(BAM_sorted, minTotalMatchVirus, minParcialMatchVirus, maxMatchCheckMAPQVirus, minMAPQVirus, maxBasePercVirus, minLccVirus, mode='LR')
