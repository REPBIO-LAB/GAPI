...
if __name__ == '__main__':
	...
	# Output
	parser.add_argument('--VCFInfoFields', default="VTYPE,NBTOTAL,NBTUMOR,NBNORMAL,LEN,DISCORDANT,CLIPPING,NBDISCORDANT,NBCLIPPING,IDENTITY,ORIENTATION,BKP2,DISCORDANTMAPQ,CLIPPINGMAPQ,CLIPDISC,SPECIDENT,DISCDUP,CLIPDUP,REP,REPSUB,DIST,REGION,GENE,REFSeq,BKPCONSSEQ,BKP2CONSSEQ,BKPREPRESEQ,BKP2REPRESEQ,INTBKP,INTBKP2,CLIPTYPE,CLIPTYPE2", dest='VCFInfoFields', type=str, help='Comma separated list of INFO fields to display in output VCF (VTYPE,NBTOTAL,NBTUMOR,NBNORMAL,LEN,DISCORDANT,CLIPPING,NBDISCORDANT,NBCLIPPING,IDENTITY,ORIENTATION,BKP2,DISCORDANTMAPQ,CLIPPINGMAPQ,CLIPDISC,SPECIDENT,DISCDUP,CLIPDUP,REP,REPSUB,DIST,REGION,GENE,REFSeq,BKPSEQ,BKP2SEQ,INTBKP,INTBKP2,CLIPTYPE,CLIPTYPE2) *NOTE that REFSeq is incompatible with --no-VCFREF. Default: All are included')
